...
The observed dispersion statistic D_obs was extracted from model outputs; neutral calibration parameters (mu0, sigma0) were taken from the same run metadata.
