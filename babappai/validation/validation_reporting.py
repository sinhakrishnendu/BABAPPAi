...
def generate_validation_report(*, input_dir: str, outdir: str) -> Dict[str, Any]:
    ...
    report_lines = [
        ...
        "",
        "## 9) Limitations",
        "- The BABAPPAΩ neural model is intentionally frozen; updates should target calibration/applicability/reporting layers rather than model replacement.",
        "",
        "## 10) Recommended manuscript wording",
        "- \"BABAPPAi is the operational framework around the canonical frozen BABAPPAΩ model.\"",
        ...
        "",
        "## 11) Software and model citation notes",
        "- Cite BABAPPAi software version and the BABAPPAΩ model DOI as the fixed canonical inference artifact.",
        "",
    ]
